...
<body>
	...
	<section>
		<div id="contents">
			<div class="container">
				<ul class="tabs">
					<li class="tab-link current" data-tab="tab-1">학사관련문의</li>
				</ul>
				...
				<div id="tab-1" class="tab-content current">
					<div class="table">
						...
						<!-- 글쓰기 버튼 -->
						<p class="mbutton">
							<input class="button" type="button" value="글쓰기" onclick="location.href='comm_Write.jsp?comm_groupn=2'" />
						</p>
						...
						<form action="comm_Q_And_A.jsp" method="post" name="search_frm">
							<p class="select">
								...
								<input type="text" name="search" /> <input type="submit" class="button" value="검색" onclick="search_ok()"/>
							</p>
						</form>
